...
import { DefectTriagePage } from '@/pages/DefectTriagePage';
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route element={<Layout />}>
          ...
          <Route path="/releases/:releaseId/tests" element={<TestExecutionPage />} />
          <Route path="/releases/:releaseId/defects" element={<DefectTriagePage />} />
          <Route path="/releases/:releaseId/risks" element={<RiskReviewPage />} />
