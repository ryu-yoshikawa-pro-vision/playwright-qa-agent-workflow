...
| 3    | [`02-target-project-profile.md`](02-target-project-profile.md) | 対象アプリの URL、認証、データ方針、テスト実行方法を整理する |
| 4    | [`03-service-exploration.md`](03-service-exploration.md)       | 対象アプリ全体を探索する                                     |
| 5    | [`04-feature-workflow.md`](04-feature-workflow.md)             | 1機能をテスト計画、設計、生成まで進める                      |
| 6    | [`05-artifact-reading-guide.md`](05-artifact-reading-guide.md) | どの成果物を見れば現在状態が分かるか確認する                 |
| 7    | [`06-troubleshooting.md`](06-troubleshooting.md)               | 困ったときの確認方法を調べる                                 |
| 8    | [`glossary.md`](glossary.md)                                   | 用語の意味を確認する                                         |
